  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4 border border-border rounded-md p-3",
        caption: "flex justify-center pt-1 items-center w-full mb-2 gap-2",
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-9 font-light text-[0.7rem] opacity-60 flex justify-center items-center",
