...
// Тип для payload tooltip recharts
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[4rem] items-start gap-0.5 rounded-md border border-border/50 bg-background px-1.5 py-1 text-[10px] shadow-xl",
          className
        )}
      >
