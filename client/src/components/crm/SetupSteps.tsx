 ...
 * Provider-agnostic UI used by CRM integrations.
 */
export function SetupSteps({ currentStep, steps, onStepClick }: SetupStepsProps) {
    return (
        <div className="rounded-xl border border-border bg-card p-6">
            <h3 className="text-body-sm font-bold text-muted-foreground uppercase tracking-wider mb-6">Setup Steps</h3>
            <div className="relative flex flex-col">
                {steps.map((step, index) => {
                    ...
                    return (
                        ...
                        >
                            {!isLast && <div className="absolute left-[15px] top-10 bottom-0 w-0.5 bg-border z-0" />}
                            ...
                            <div className="relative z-10 shrink-0">
                                <div
                                    className={cn(
                                        ...
                                        isActive &&
                                            'border-2 border-status-online bg-status-online/10 text-status-online shadow-[0_0_0_3px_rgba(34,197,94,0.15)]',
